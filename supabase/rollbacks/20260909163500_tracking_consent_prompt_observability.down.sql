-- Reverte somente o novo nome de evento. Os registros já coletados precisam
-- ser removidos antes deste rollback se existirem, para a constraint validar.

begin;

delete from private.site_events_anon where event_name = 'consent_prompt';
